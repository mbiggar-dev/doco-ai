...
def setup_llm_and_embeddings():
    ...
    """
    Settings.llm = Ollama(
        model="llama3.2",  # or qwen2.5:7b, whatever you pulled
...
def ingest_documents():
    """
    the actual indexing magic happens here
    """
    print("setting up models...")
    setup_llm_and_embeddings()
    
    # chromadb is our vector database - stores embeddings for fast retrieval
    ...
    # this reads everything in ./docs recursively
